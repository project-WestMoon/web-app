...
const marketData = [
	{
		market_name: '한식당 맛나네',
		market_description:
			'정통 한식을 맛볼 수 있는 맛나네 식당은 건강한 재료와 정성으로 만들어진 다양한 한식 메뉴를 제공합니다.',
		reviews: [
			'음식이 너무 맛있어요! 특히 비빔밥이 최고였어요.',
	...
	},
	{
		market_name: '김밥 천국',
		market_description:
			'다양한 종류의 김밥과 함께 즉석에서 만들어지는 맛있는 분식을 즐길 수 있는 곳입니다.',
		reviews: [
			'김밥이 신선하고 맛있었어요. 특히 참치김밥이 최고!',
			'빠르게 나오는 음식들 덕분에 바쁜 점심시간에도 좋습니다.',
			'분식의 천국이라고 할 만큼 메뉴가 다양해요.',
			'가격도 저렴하고 맛도 좋아서 자주 오게 됩니다.',
			'튀김과 라면도 맛있고 추천할 만한 곳이에요.',
			'직원들이 친절하고 서비스도 빠릅니다.'
		],
        coord: [40, 40]
	},
	{
		market_name: '수제빵집 바삭이네',
		market_description:
			'매일 아침 구워내는 수제빵을 판매하는 곳으로, 신선한 재료로 만든 다양한 빵을 제공합니다.',
		reviews: [
	...
	},
	{
		market_name: '새벽 해산물',
		market_description:
			'매일 새벽 잡아 올린 신선한 해산물을 저렴하게 판매하는 해산물 전문점입니다.',
		reviews: [
